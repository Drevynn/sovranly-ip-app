...
const DEFAULT_MARKETPLACE_ASSETS = [
  {
    ...
    tags: ['Synthwave', 'Stems', 'Analog', 'Sync-Ready', 'Modular'],
    royalty: 85,
  ...
  },
  {
    ...
    folder: 'Software Packages',
    tags: ['NextJS', 'Web3', 'Tailwind', 'ZeroTrust', 'SmartContracts'],
    royalty: 90,
  ...
  },
  {
    ...
    type: 'Artwork / Visual Art',
    folder: '3D & Virtual Worlds',
    tags: ['3D-Render', 'Metaverse', 'glTF', 'Cyberpunk', 'Environment'],
    royalty: 80,
  ...
  },
  {
    ...
    type: 'Software / Utility',
    folder: 'Software Packages',
    tags: ['Oracle', 'Chainlink', 'Telemetry', 'DeFi', 'Streaming'],
    royalty: 85,
