  ...
  return (
    <header className="h-20 border-b border-zinc-900 px-8 flex items-center justify-between bg-zinc-950/50 backdrop-blur-md">
      ...
      <div className="flex items-center gap-4">
        <div className="px-5 py-2.5 bg-emerald-950/30 border border-emerald-500/20 text-emerald-400 text-[10px] uppercase tracking-widest rounded-full flex items-center gap-2">
